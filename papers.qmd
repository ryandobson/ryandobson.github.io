...
::: {.paper-figure}
![](files/figures/five-love-languages.png){fig-alt="Two panels, factor expression score and factor reception score, plotting rank mean against love language rank for men and women. Both sexes show the same declining pattern."}

Rank means decline the same way for men and women across both the expression
